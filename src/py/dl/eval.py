...
if(nn.prediction_type() == "class"):
  ...
  # if(args.json_translation):
  #   with open(args.json_translation, "r") as f:
  #     translation_table = json.load(f)["table"]
  #     y_true_arr = [translation_table[str(tlabel)] for tlabel in y_true_arr]
