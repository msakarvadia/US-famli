...
int main (int argc, char * argv[]){
    ...
    if(numSamplesCrossBig > 0){
        ...
        offsets.push_back({-8,0,0});
        offsets.push_back({-8,1,0});
        offsets.push_back({-7,1,0});
        offsets.push_back({-6,1,0});
        offsets.push_back({-5,1,0});
        offsets.push_back({-4,1,0});
        offsets.push_back({-3,1,0});
        offsets.push_back({-2,1,0});
        offsets.push_back({-2,0,0});
        offsets.push_back({-2,-1,0});
        offsets.push_back({-3,-1,0});
        offsets.push_back({-4,-1,0});
        offsets.push_back({-5,-1,0});
        ...
        offsets.push_back({0, -8 ,0});
        offsets.push_back({-1, -8 ,0});
        offsets.push_back({-1, -7 ,0});
        offsets.push_back({-1, -6 ,0});
        offsets.push_back({-1, -5 ,0});
        offsets.push_back({-1, -4 ,0});
        offsets.push_back({-1, -3 ,0});
        offsets.push_back({-1, -2 ,0});
        offsets.push_back({0, -2 ,0});
        offsets.push_back({1, -8 ,0});
        offsets.push_back({1, -7 ,0});
        offsets.push_back({1, -6 ,0});
        offsets.push_back({1, -5 ,0});
        ...
        // vector< InputImageNeighborhoodIteratorType::OffsetType > offsets_inner;

        // offsets_inner.push_back({-7,0,0});
        // offsets_inner.push_back({-6,0,0});
        // offsets_inner.push_back({-5,0,0});
        // offsets_inner.push_back({-4,0,0});
        // offsets_inner.push_back({-3,0,0});        
        // offsets_inner.push_back({3,0,0});
        // offsets_inner.push_back({4,0,0});
        // offsets_inner.push_back({5,0,0});
        // offsets_inner.push_back({6,0,0});
        ...
        // offsets_inner.push_back({0, -7 ,0});
        // offsets_inner.push_back({0, -6 ,0});
        // offsets_inner.push_back({0, -5 ,0});
        // offsets_inner.push_back({0, -4 ,0});
        // offsets_inner.push_back({0, -3 ,0});
